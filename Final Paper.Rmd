...
Data <-Data2 %>%
  select(GAF_africa,GAF_eastAsia,GAF_oceania,GAF_centralAsia,GAF_europe,GAF_amerind, FDH_3_Household_Income,FDH_3_Household_IncomeLog,Gender,
...
m0 <- glm(UseSubstance~GAF_africa+GAF_eastAsia+GAF_oceania+GAF_centralAsia+GAF_europe +Gender+log(Age_At_PhenX_Completion)+rs4680+r+rs12364283,
            family='binomial',data=Data)

m1 <- glm(UseSubstance~GAF_africa+GAF_eastAsia+GAF_oceania+GAF_centralAsia+GAF_europe+Gender+log(Age_At_PhenX_Completion)+rs4680+rs12364283+FD,
            family='binomial',data=Data)
